...
public class CidadeDAO implements GenericDAO {
    ...
    public Boolean inserir(Object objeto) {
        ...
        try {
            ...
            try {
                System.out.println("Problemas ao cadastrar a Cidade na DAO! Erro: " + ex.getMessage());
                ex.printStackTrace();
                conexao.rollback();
    ...
    public List<Cidade> listar(int idEstado) {
        ...
        try {
            ...
            System.out.println("Problemas ao listar<cidade> Cidade na DAO! Erro: " + ex.getMessage());
        }
        return resultado;
    }
