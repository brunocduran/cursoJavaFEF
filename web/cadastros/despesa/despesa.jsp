                ...
                <tbody>
                    <c:forEach var="despesa" items="${despesas}">
                        <tr>
                            ...
                            <td align="center">
                                <fmt:formatDate pattern="dd/MM/yyyy" value="${despesa.dataDocumento}" />
                            </td>
                            <td align="right">
                                <fmt:formatNumber value="${despesa.valorDespesa}" type="currency" />
                            </td>
                            <td align="right">
                                <fmt:formatNumber value="${despesa.valorPago}" type="currency" />
                            </td>
                            <td align="center">
                                <a href="#" id="deletar" title="Excluir"
                                   onclick="deletar(${despesa.idDespesa})">
                                    <button>Excluír</button>
                                </a>
                            </td>
                            <td align="center">
                                <a
                                    href="${pageContext.request.contextPath}/DespesaCarregar?idDespesa=${despesa.idDespesa}">
